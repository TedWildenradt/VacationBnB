...
ActiveRecord::Base.transaction do
  ...
  home4 = Home.create(owner_id: user2.id, num_guests: 3, price: 190, city: 'San Francisco', state: 'CA', zip: 94116, country: "US", home_type: "House", bed_count: 3, bathrooms: 1, bedrooms: 3, title: "", description: "Do you wish to stay in a comfy private room at the center of San Francisco? I would love to welcome you in my lovely home! If you want to experience San Francisco as a real local, then this is the accommodation you need. In a very lively and accessible neighborhood, in a everchanging street rich of restaurants, art galleries and small shops, you will discover the San Francisco where I live and which I love for now 20 years")
  home5 = Home.create(owner_id: user2.id, num_guests: 3, price: 320, city: 'San Francisco', state: 'CA', zip: 94117, country: "US", home_type: "House", bed_count: 3, bathrooms: 1, bedrooms: 3, title: "Cozy Three Bedroom", description: "The guest apartment has its own entrance located on the ground level of our home. The private apartment is 720 sq ft and has 8 ft ceilings. The living room and kitchen are new as of 2013 and the bath and the two bedrooms are remodeled.")
