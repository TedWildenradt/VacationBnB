...
ActiveRecord::Base.transaction do
  ...
  # New York Homes
  home11 = Home.create(owner_id: user4.id, num_guests: 5, price: 180, city: 'New York', state: 'NY', zip: 10004, country: "US", home_type: "Private Room in Loft", bed_count: 3, bathrooms: 2, bedrooms: 1, title: 'Manhattan Luxury', description: "Downtown, the best bit of Manhattan. One of, if not the, LARGEST space on available in NYC. Your Own PRIVATE Bathroom & PRIVATE Bedroom, a Terrace off the bedroom, near to subways/buses, restaurants, bars, real luxury right in the middle of things.", lat: 40.703382, lng: -74.013661)
  home12 = Home.create(owner_id: user4.id, num_guests: 1, price: 90, city: 'New York', state: 'NY', zip: 10019, country: "US", home_type: "Private Room in Apartment", bed_count: 1, bathrooms: 1, bedrooms: 1, title: 'City Experience', description: "Cozy, warm atmosphere, perfect for the traveler looking for a real NY experience.This reservation is for one person. If you want to book for 2 guests it is an extra $100 per night. Best neighborhood in midtown Manhattan for the best price. In the hub of Hell's Kitchen nightlife, restaurants, theaters, museums.", lat: 40.768909, lng:  -73.992805)
  home13 = Home.create(owner_id: user4.id, num_guests: 2, price: 75, city: 'New York', state: 'NY', zip: 10003, country: "US", home_type: "Private Room in Apartment", bed_count: 1, bathrooms: 1, bedrooms: 1, title: 'Sunny and Modern', description: "This clean and very comfortable room in the East Village has spectacular views of downtown Manhattan and is a block away from Tompkins Square Park. Am always excited to share the space with guests! Thanks for taking a look.", lat: 40.732091, lng: -73.987754)
  home14 = Home.create(owner_id: user4.id, num_guests: 10, price: 400, city: 'New York', state: 'NY', zip: 10013, country: "US", home_type: "Entire Loft", bed_count: 3, bathrooms: 2, bedrooms: 3, title: 'Tribeca Loft', description: "2500 square feet TriBeCa loft with 13-feet exposed beam ceilings, hardwood floors and over-sized windows. Three bedrooms, two bathrooms, large kitchen, washer/dryer, art, and modern furnishings.", lat: 40.721827, lng: -74.010359)
  home15 = Home.create(owner_id: user4.id, num_guests: 4, price: 90, city: 'New York', state: 'NY', zip: 10012, country: "US", home_type: "Private Room in Apartment", bed_count: 2, bathrooms: 1, bedrooms: 1, title: 'Soho Loft with Massive Couch', description: "2500 square feet TriBeCa loft with 13-feet exposed beam ceilings, hardwood floors and over-sized windows. Three bedrooms, two bathrooms, large kitchen, washer/dryer, art, and modern furnishings.", lat: 40.726193, lng: -73.999036)
